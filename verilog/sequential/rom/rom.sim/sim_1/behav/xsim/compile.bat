...
REM
REM Generated by Vivado on Wed Jan 14 02:02:37 +0530 2026
...
echo "xvlog --incr --relax -prj testrom_vlog.prj"
call xvlog  --incr --relax -prj testrom_vlog.prj -log xvlog.log
