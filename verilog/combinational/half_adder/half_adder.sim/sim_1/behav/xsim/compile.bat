...
REM
REM Generated by Vivado on Thu Nov 06 23:35:20 +0530 2025
...
echo "xvhdl --incr --relax -prj half_adder_tb_vhdl.prj"
call xvhdl  --incr --relax -prj half_adder_tb_vhdl.prj -log xvhdl.log
