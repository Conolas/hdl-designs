...
REM
REM Generated by Vivado on Fri Nov 07 00:04:43 +0530 2025
...
echo "xvhdl --incr --relax -prj half_sub_tb_vhdl.prj"
call xvhdl  --incr --relax -prj half_sub_tb_vhdl.prj -log xvhdl.log
