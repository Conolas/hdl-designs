...
REM
REM Generated by Vivado on Fri Nov 07 02:45:48 +0530 2025
...
echo "xvhdl --incr --relax -prj comp_tb_vhdl.prj"
call xvhdl  --incr --relax -prj comp_tb_vhdl.prj -log xvhdl.log
