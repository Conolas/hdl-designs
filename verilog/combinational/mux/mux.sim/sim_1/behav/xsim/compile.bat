...
REM
REM Generated by Vivado on Fri Sep 26 10:45:35 +0530 2025
...
echo "xvhdl --incr --relax -prj testmux_vhdl.prj"
call xvhdl  --incr --relax -prj testmux_vhdl.prj -log xvhdl.log
