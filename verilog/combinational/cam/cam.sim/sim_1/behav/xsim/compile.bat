...
REM
REM Generated by Vivado on Wed Jan 14 03:30:54 +0530 2026
...
echo "xvlog --incr --relax -prj testcam_vlog.prj"
call xvlog  --incr --relax -prj testcam_vlog.prj -log xvlog.log
